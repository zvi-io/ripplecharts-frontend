...
angular.module('ripplecharts.landing', [
    ...
    .controller('LandingCtrl', function LandingCtrl($scope, $state, gateways) {
        ...
        $scope.metrics = {
            totalTradeVolume: {
                label: '<span style="display: none;">Total ' + translateCoin('XRP') + ' Trade Volume <small>(All Exchanges)</small></span>',
                link: '#/multimarkets'
                /*      link: '#/xrp-markets'*/
            },
            tradeVolumeRCL: {
                label: translateCoin('XRP') + ' Ledger Trade Volume <small>(All Pairs)<small>',
                link: '#/trade-volume'
            },
            paymentVolumeRCL: {
                label: translateCoin('XRP') + ' Ledger Payment Volume'
            },
            capitalizationXRP: {
